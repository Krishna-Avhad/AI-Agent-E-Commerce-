...
CREATE TABLE IF NOT EXISTS merchant_settings (
  ...
  agent_max_order_value NUMERIC(10,2) DEFAULT 500000.00,
  agent_daily_limit NUMERIC(10,2) DEFAULT 2500000.00,
  require_payment_confirmation BOOLEAN DEFAULT true,
  max_discount_percent NUMERIC(5,2) DEFAULT 15.00,
  max_discount_amount NUMERIC(10,2) DEFAULT 25000.00,
