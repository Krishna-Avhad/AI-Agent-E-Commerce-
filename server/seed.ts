...
export async function seedNormalizedDatabase() {
  ...
  const products = [
    ...
    // --- CATEGORY: Audio (prod-01 to prod-05) ---
    {
      ...
      category: 'Audio',
      price: Math.round(349),
      original_price: Math.round(399),
      currency: 'INR',
      rating: 4.9,
      review_count: 428,
      stock_quantity: 84,
    ...
    },
    {
      ...
      category: 'Audio',
      price: Math.round(159),
      original_price: Math.round(199),
      currency: 'INR',
      rating: 4.8,
      review_count: 284,
      stock_quantity: 55,
    ...
    },
    {
      ...
      category: 'Audio',
      price: Math.round(129),
      original_price: Math.round(159),
      currency: 'INR',
      rating: 4.9,
      review_count: 198,
      stock_quantity: 34,
    ...
    // --- CATEGORY: Workstation & Keyboards (prod-06 to prod-10) ---
    {
      ...
      price: Math.round(189),
      original_price: Math.round(220),
      currency: 'INR',
      rating: 4.8,
      review_count: 312,
      stock_quantity: 42,
    ...
    },
    {
      ...
      category: 'Workstation',
      price: Math.round(549),
      original_price: Math.round(620),
      currency: 'INR',
      rating: 4.9,
      review_count: 388,
      stock_quantity: 23,
    ...
    // --- CATEGORY: Displays (prod-11 to prod-14) ---
    {
      ...
      category: 'Displays',
      price: Math.round(699),
      original_price: Math.round(799),
      currency: 'INR',
      rating: 4.9,
      review_count: 512,
      stock_quantity: 19,
    ...
    },
    {
      ...
      category: 'Displays',
      price: Math.round(899),
      original_price: Math.round(999),
      currency: 'INR',
      rating: 4.9,
      review_count: 240,
      stock_quantity: 14,
    ...
    },
    {
      ...
      category: 'Displays',
      price: Math.round(119),
      original_price: Math.round(149),
      currency: 'INR',
      rating: 4.8,
      review_count: 320,
      stock_quantity: 55,
    ...
    },
    {
      ...
      category: 'Displays',
      price: Math.round(249),
      original_price: Math.round(299),
      currency: 'INR',
      rating: 4.9,
      review_count: 188,
      stock_quantity: 28,
  ...
  const bundles = [
    ...
    },
    {
      ...
      match_score: 97,
      original_total: Math.round(446),
      bundle_price: Math.round(369),
      savings_percentage: 17,
      category: 'Ergonomics',
    ...
    },
    {
      ...
      match_score: 94,
      original_total: Math.round(611),
      bundle_price: Math.round(499),
